          ...
          <div className="container">
            ...
            <div className="about-grid">
              <div className="about-image">
                <img src="Taha.jpeg" alt="Taha Choudhary" />
              </div>
              ...
              <div className="skill-card">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', marginBottom: '1.5rem' }}>
                  <div style={{ width: '80px', height: '80px', background: 'white', borderRadius: '1rem', padding: 0, overflow: 'hidden', flexShrink: 0 }}>
                    <img src="https://i.pinimg.com/1200x/29/95/95/29959595fe22edde8408b060d3ac3d82.jpg" alt="Figma" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                  </div>
                  <div style={{ flex: 1 }}>
            ...
            <div className="projects-grid">
              ...
              <div className="project-card">
                <div className="project-image" style={{ padding: 0 }}>
                  <img src="hello.png" alt="Wanderlust Travel Website" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '1.5rem 1.5rem 0 0' }} />
                </div>
              ...
              <div className="project-card">
                <div className="project-image" style={{ padding: 0, background: '#1E1E1E' }}>
                  <img src="bok.png" alt="Figma Design System" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '1.5rem 1.5rem 0 0' }} />
                </div>
                <div className="project-content">
              ...
              <div className="contact-methods">
                <div className="contact-item">
                  <div className="contact-icon" style={{ background: 'white', padding: '0.5rem' }}>
                    <img src="download copy.jpg" alt="Email" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                  </div>
                ...
                <div className="contact-item">
                  <div className="contact-icon" style={{ background: 'white', padding: '0.5rem' }}>
                    <img src="LinkedIn copy.jpg" alt="LinkedIn" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                  </div>
                  <div className="contact-item-content">
                    <h4>LinkedIn</h4>
                ...
                <div className="contact-item">
                  <div className="contact-icon" style={{ background: 'white', padding: '0.5rem' }}>
                    <img src="Github Logo PNG Vector (SVG) Free Download copy.jpg" alt="GitHub" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                  </div>
                  <div className="contact-item-content">
                    <h4>GitHub</h4>
